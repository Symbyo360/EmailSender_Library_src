#ifndef SYEMAILSENDER_H
#define SYEMAILSENDER_H
#include <vector>
#include <string.h>
#include <assert.h>
...
public:
	...
	MailError(ErrorType err_) : ErrorCode(err_) {}
	ErrorType GetErrorNum(void) const {return ErrorCode;}
...
private:
	...
	void OpenSSLConnect();
	void CleanupOpenSSL();
	void ReceiveData_SSL(ssl_st* ssl, Command_Entry* pEntry);
	void SendData_SSL(ssl_st* ssl, Command_Entry* pEntry);
	void StartTls();
};
